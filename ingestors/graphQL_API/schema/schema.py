...
from schema.subscription_resolver.environment_data_sub_resolver import subscription
...
schema = make_executable_schema(combined_type_defs, [root_query, vital_params_query], subscription)
