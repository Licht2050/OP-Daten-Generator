...
def resolve_get_all_patient(root, info):
    """
...
def resolve_get_all_patient_by_op_date(root, info, op_date):
    """
...
def resolve_get_all_patient_by_op_type(root, info, op_type):
    """
...
def resolve_get_all_patient_by_anesthesia_type(root, info, anesthesia_type):
    """
