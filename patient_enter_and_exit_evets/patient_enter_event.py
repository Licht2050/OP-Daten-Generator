...
def generate_patient_entry_event(patient_info_config):
    
    patient_entry_exit_events = {
        "Patient_ID": patient_info_config["Patient_ID"],
        "event_type": "patient_entered"
    }
...
def main():
    ...
    try:
        patient_entry_exit_events = generate_patient_entry_event(patient_info_config)
